...
**TL;DR:** In this folder we develop the relevant topics related to the ISM, particularly H II regions, which come from the hypothesis the ionized gas is [turbulent](<Theory/Turbulence.md>) .
