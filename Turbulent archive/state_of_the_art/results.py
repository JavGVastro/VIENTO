...
def loadresults():
    ...
    samples=pd.read_csv(str(datapath_names) +'//sample-names-dist.csv',header=None)
    Names=pd.read_csv(str(datapath_names) +'//formal-names-dist.csv',header=None)
